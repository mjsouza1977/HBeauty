...
begin
    try
        try
            ...
            ControllerConexao.qryQuery.SQL.Add('SOBRENOME_VEND = :SOBRENOME_VEND,');
            ...
            ControllerConexao.qryQuery.ParamByName('SOBRENOME_VEND').AsString  := ASobreNome;
...
begin
    try
        try
            ...
            ControllerConexao.qryQuery.SQL.Add('(NOME_VEND, SOBRENOME_VEND, RG_VEND, CPF_VEND, LOG_VEND, NRLOG_VEND,');
            ...
            ControllerConexao.qryQuery.Close;
            ControllerConexao.qryQuery.SQL.Clear;
            ControllerConexao.qryQuery.SQL.Add('SELECT ID_VEND FROM HBVENDEDOR WHERE CPF_VEND = ' + QuotedStr(ACPF));
...
begin
     try
         ...
         if AId > 0 then
            ASql := ASql + ' AND ID_VEND = ' + AID.ToString;
